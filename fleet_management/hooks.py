...
app_publisher = "Aditya Verma"
app_description = "A fleet management system for managing vehicles, drivers, trips, and maintenance."
app_email = "django.urbaneats@gmail.com"
app_license = "mit"
...
# `fleet_management/dock/fleet_management/fleet_management.json` for git to carry. An app that ships none has no
...
# setup_wizard_url = "/fleet_management/setup"
...
# before_disable = "fleet_management.uninstall.before_disable"
# after_disable = "fleet_management.uninstall.after_disable"
# before_enable = "fleet_management.install.before_enable"
# after_enable = "fleet_management.install.after_enable"
...
# after_build = "fleet_management.build.after_build"

# To hook into the build process of other apps
# The list of apps being built is passed as an argument

# after_app_build = "fleet_management.build.after_app_build"
...
# awesomebar_search = ["fleet_management.search.awesomebar_results"]
...
# after_file_upload = ["fleet_management.utils.after_file_upload"]
